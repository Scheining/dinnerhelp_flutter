...
import '../../data/models/booking_notification_data.dart';
...
abstract class NotificationService {
  ...
  Future<Either<Failure, void>> schedule24HourReminder(String bookingId);
  
  Future<Either<Failure, void>> schedule1HourReminder(String bookingId);
  
  Future<Either<Failure, void>> sendCompletionReview(String bookingId);
  ...
  Future<Either<Failure, void>> processNotificationQueue();
  
  Future<Either<Failure, void>> retryFailedNotifications();
}
...
class NotificationServiceImpl implements NotificationService {
  ...
  const NotificationServiceImpl(this._repository);
  ...
  Future<void> _processEmailNotification(NotificationEntity notification) async {
    // Implementation would call Postmark API
  ...
  Future<void> _processPushNotification(NotificationEntity notification) async {
    // Implementation would call OneSignal API
    // For now, just mark as sent
    await _repository.updateNotificationStatus(
      notification.id,
      NotificationStatus.sent,
